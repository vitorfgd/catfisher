...
export const MHS_TEXTURE_PATHS = {
  ...
  [AssetIds.boatSceneSky]: '@sprites/bg-sky.png',
  [AssetIds.boatSceneSurface1]: '@sprites/bg-surface-1.png',
  [AssetIds.boatSceneSurface2]: '@sprites/bg-surface-2.png',
  [AssetIds.boatSceneBoat]: '@sprites/boat-sprite.png',
  [AssetIds.boatSceneSurface3]: '@sprites/bg-surface-3.png',
  [AssetIds.boatSceneSurface4]: '@sprites/bg-surface-4.png',
  [AssetIds.boatSceneSurface5]: '@sprites/bg-surface-5.png',
  ...
  [AssetIds.leaderboardSplashArt]: '@sprites/splash-art-leaderboard.png',
